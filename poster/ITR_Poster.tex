...
\legend{Quantised periodogram $q=1.5$, Quantised periodogram $q=5$,Seperable line search,Least squares Theory,Periodogram Theory, Least squares,Periodogram}
...
%    \selectcolormodel{gray} 
    \begin{axis}[font=\footnotesize,xmode=log,ymode=log,height=15cm,width=25cm,xlabel={$N$},ylabel={time (ms)},ylabel style={at={(0.085,0.42)}},xlabel style={at={(0.5,0.13)}}, legend style={draw=none,fill=none,legend pos=north west,cells={anchor=west},font=\footnotesize},xmin=7,xmax=36000]
      ...
      \legend{Periodogram, Least squares, Seperable line search, Quantised periodogram $q=5$}
   \end{axis}
  \end{tikzpicture}  
...
\nocite{clarkson_estimate_period_pulse_train_1996,Sidiropoulos2005,5585849,Quinn_sparse_noisy_SSP_2012,Quinn20013asilomar_period_est}

...
\\
\textbf{Response:}
We reponse to each of the questions of the reviewer in turn:
...
\item \text{How have the authors selected the total number of iterations?} In our implementation iterations are performed until the absolute difference between consequentive iterations is less than $10^{-7}$.

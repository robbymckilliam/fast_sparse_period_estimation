...
\begin{figure*}[tp]  
  ...
  \begin{tikzpicture}  
    \selectcolormodel{gray} 
    \begin{axis}[name=plot1,font=\footnotesize,xmode=log,ymax=4e-1,ymode=log,height=10cm,width=9cm,xlabel={$\sigma^2$},ylabel={MSE},ylabel style={at={(0.06,0.24)}},xlabel style={at={(0.5,0.07)}}, legend style={at={(1.1,1.02)}, anchor=south,legend columns=7, cells={anchor=west,/tikz/every even column/.append style={column sep=0.2cm}}}]
\addplot[mark=none,color=black] table {code/data/PeriodogramCLTN200fixed1}; 
      \addplot[mark=none,color=black,dashed] table {code/data/NormalisedLLSCLTN200fixed1};
      \addplot[mark=none,color=black,dotted] table {code/data/CRBN200fixed1};
            \addplot[mark=triangle,only marks,mark options={solid,fill=black,scale=1}] table {code/data/QuantisedPeriodogramFFTN200q1.5fixed1};
      \addplot[mark=*,only marks,color=black,mark options={solid,fill=black,scale=0.5}] table {code/data/QuantisedPeriodogramFFTN200q5.0fixed1};
      \addplot[mark=o,only marks,color=black,mark options={solid,fill=black,scale=1}] table {code/data/PeriodogramN200fixed1};
       \addplot[mark=x,only marks,color=black,mark options={solid,fill=black,scale=1.2}] table {code/data/NormalisedSamplingLLSN200fixed1}; 
 %      \addplot[mark=square,only marks,color=black,mark options={solid,fill=black,scale=0.8}] table {code/data/SLS2novlpN200fixed1};
      \addplot[mark=square,only marks,color=black,mark options={solid,fill=black,scale=1}] table {code/data/SLS2newN200fixed1};
     \legend{Periodogram theory, Least squares theory, CRB, $q=\tfrac{3}{2}f_{\text{max}}$, $q=5 f_{\text{max}}$, Periodogram, Least squares, SLS2-new}
     %\node[rotate=17,font=\footnotesize] at (axis cs:6e-4,1e-7) {$N=200$};
   \end{axis}   \begin{axis}[name=plot2,at={(4.7,0)},ymax=4e-1,font=\footnotesize,xmode=log,ymode=log,height=10cm,width=9cm,xlabel={$\sigma^2$},ylabel={MSE},ylabel style={at={(0.06,0.23)}},xlabel style={at={(0.5,0.07)}}]
\addplot[mark=none,color=black] table {code/data/PeriodogramCLTN200fixed10}; 
      \addplot[mark=none,color=black,dashed] table {code/data/NormalisedLLSCLTN200fixed10};
      \addplot[mark=none,color=black,dotted] table {code/data/CRBN200fixed10};
            \addplot[mark=triangle,only marks,mark options={solid,fill=black,scale=1}] table {code/data/QuantisedPeriodogramFFTN200q1.5fixed10};
      \addplot[mark=*,only marks,color=black,mark options={solid,fill=black,scale=0.5}] table {code/data/QuantisedPeriodogramFFTN200q5.0fixed10};
      \addplot[mark=o,only marks,color=black,mark options={solid,fill=black,scale=1.1}] table {code/data/PeriodogramN200fixed10};
       \addplot[mark=x,only marks,color=black,mark options={solid,fill=black,scale=1.3}] table {code/data/NormalisedSamplingLLSN200fixed10}; 
  %     \addplot[mark=square,only marks,color=black,mark options={solid,fill=black,scale=0.8}] table {code/data/SLS2novlpN200fixed10};
       \addplot[mark=square,only marks,color=black,mark options={solid,fill=black,scale=1}] table {code/data/SLS2newN200fixed10};
     %\node[rotate=16,font=\footnotesize] at (axis cs:7e-4,1.5e-14) {$N=200$}; 
   \end{axis} 
  \end{tikzpicture}   

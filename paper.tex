...
\]
where $r_n = 2s_n \in \ints$.  Thus, to ensure identifiability, it is necessary to assume that $T_0$ lies in some interval $(T_{\text{min}}, T_{\text{max}})$ where $T_{\text{max}} < 2T_{\text{min}}$.  We also assume that $y_1,\dots,y_N$ are in ascending order.  The periodogram estimator is unchanged by a permutation observations, and so, this assumption can be made without loss of generality because it amounts only to sorting the observations if required.
...
\]
where $A = 1$ and $W = e^{ -2\pi j D/q}$.  Now $V_0,\dots,V_{K-1}$ can be efficiently computed by the chirp z-transform~\cite{Rabiner1969}.  Putting
\[
...
\begin{figure*}[t] 
  ...
  \begin{tikzpicture} 
    \selectcolormodel{gray} 
    \begin{axis}[name=plot1,font=\footnotesize,xmode=log,ymode=log,height=10cm,width=9cm,xlabel={$\sigma^2$},ylabel={MSE},ylabel style={at={(0.19,0.28)}},xlabel style={at={(0.5,0.14)}}, legend style={at={(1.1,1.02)}, anchor=south,legend columns=7, cells={anchor=west,/tikz/every even column/.append style={column sep=0.2cm}}}]
      ...
      \addplot[mark=o,only marks,color=black,mark options={solid,fill=black,scale=1}] table {code/data/PeriodogramN30geom1};
       \addplot[mark=x,only marks,color=black,mark options={solid,fill=black,scale=1}] table {code/data/NormalisedSamplingLLSN30geom1}; 
...
%      \addplot[mark=x,only marks,color=black,mark options={solid,fill=black,scale=0.8}] table {code/data/NormalisedSamplingLLSN200};
      \addplot[mark=none,color=black] table {code/data/PeriodogramCLTN1200geom1};
      \addplot[mark=none,color=black,dashed] table {code/data/NormalisedLLSCLTN1200geom1};
       \addplot[mark=o,only marks,color=black,mark options={solid,fill=black,scale=1}] table {code/data/PeriodogramN1200geom1};
       \addplot[mark=x,only marks,color=black,mark options={solid,fill=black,scale=1}] table {code/data/NormalisedSamplingLLSN1200geom1};
 %      \addplot[mark=square,only marks,color=black,mark options={solid,fill=black,scale=0.8}] table {code/data/SLS2novlpN1200geom1};
       \addplot[mark=square,only marks,color=black,mark options={solid,fill=black,scale=1}] table {code/data/SLS2newN1200geom1};
       \addplot[mark=triangle,only marks,mark options={solid,fill=black,scale=1}] table {code/data/QuantisedPeriodogramFFTN1200q1.5geom1};
      ...
      \addplot[mark=*,only marks,color=black,mark options={solid,fill=black,scale=0.5}] table {code/data/QuantisedPeriodogramFFTN1200q5.0geom1};
 %     \legend{Periodogram Theory, Least squares theory, Quantised periodogram, Periodogram, Least squares}
     \legend{Periodogram theory, Least squares theory, $q=\tfrac{3}{2}f_{\text{max}}$, $q=4 f_{\text{max}}$, Periodogram, Least squares, SLS2-new}
 ...
 \begin{axis}[name=plot2,at={(11,0)},font=\footnotesize,xmode=log,ymode=log,height=10cm,width=9cm,xlabel={$\sigma^2$},ylabel={MSE},ylabel style={at={(0.19,0.28)}},xlabel style={at={(0.5,0.14)}}]
      ...
      \addplot[mark=o,only marks,color=black,mark options={solid,fill=black,scale=1}] table {code/data/PeriodogramN30geom10};
       \addplot[mark=x,only marks,color=black,mark options={solid,fill=black,scale=1}] table {code/data/NormalisedSamplingLLSN30geom10}; 
...
%      \addplot[mark=x,only marks,color=black,mark options={solid,fill=black,scale=0.8}] table {code/data/NormalisedSamplingLLSN200}; 
      ...
      \addplot[mark=none,color=black,dashed] table {code/data/NormalisedLLSCLTN1200geom10};
       \addplot[mark=o,only marks,color=black,mark options={solid,fill=black,scale=1}] table {code/data/PeriodogramN1200geom10};
       \addplot[mark=x,only marks,color=black,mark options={solid,fill=black,scale=1}] table {code/data/NormalisedSamplingLLSN1200geom10};
 %      \addplot[mark=square,only marks,color=black,mark options={solid,fill=black,scale=0.8}] table {code/data/SLS2novlpN1100geom10};
       \addplot[mark=square,only marks,color=black,mark options={solid,fill=black,scale=1}] table {code/data/SLS2newN1200geom10};
       \addplot[mark=triangle,only marks,mark options={solid,fill=black,scale=1}] table {code/data/QuantisedPeriodogramFFTN1200q1.5geom10};
      ...
      \addplot[mark=*,only marks,color=black,mark options={solid,fill=black,scale=0.5}] table {code/data/QuantisedPeriodogramFFTN1200q5.0geom10};
 %     \legend{Periodogram Theory, Least squares theory, Quantised periodogram, Periodogram, Least squares}

...
\begin{figure*}[t] 
  ...
  \begin{tikzpicture} 
    \selectcolormodel{gray} 
    \begin{axis}[name=plot1,font=\footnotesize,xmode=log,ymax=4e-1,ymode=log,height=10cm,width=9cm,xlabel={$\sigma^2$},ylabel={MSE},ylabel style={at={(0.19,0.24)}},xlabel style={at={(0.5,0.14)}}, legend style={at={(1.1,1.02)}, anchor=south,legend columns=7, cells={anchor=west,/tikz/every even column/.append style={column sep=0.2cm}}}]
...
%      \addplot[mark=x,only marks,color=black,mark options={solid,fill=black,scale=0.8}] table {code/data/NormalisedSamplingLLSN200};
 ...
 %     \legend{Periodogram Theory, Least squares theory, Quantised periodogram, Periodogram, Least squares}
     ...
     \node[rotate=17,font=\footnotesize] at (axis cs:6e-4,9e-8) {$N=30$};
     \node[rotate=17,font=\footnotesize] at (axis cs:7e-4,1.5e-12) {$N=1200$}; 
   \end{axis} 
 \begin{axis}[name=plot2,at={(11,0)},ymax=4e-1,font=\footnotesize,xmode=log,ymode=log,height=10cm,width=9cm,xlabel={$\sigma^2$},ylabel={MSE},ylabel style={at={(0.19,0.23)}},xlabel style={at={(0.5,0.14)}}]
